...
{    
    $sqlQuery="SELECT * FROM c4  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c4 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c4 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q1_3=" . empty2null($q1_3) . ",q2_1=" . empty2null($q2_1) . ",q3_1=" . empty2null($q3_1) . ",q4_1=" . empty2null($q4_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c4(rp,q1_1,q1_2,q1_3,q2_1,q3_1,q4_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q1_3) . "," . empty2null($q2_1) . "," . empty2null($q3_1) . "," . empty2null($q4_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c4 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Establish new, mainly family medicine residency training programs, over the next 10 years Support the development of accredited family medicine or internal medicine-pediatrics residency programs by 2030 </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of residency programs established (family medicine or internal medicine-paediatrics)</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td >1.2 Number of residents enrolled at year end</td>
                <td style="text-align:center;"><b>'.$valu1['q1_2'].'</b></td>
                </tr>
                <tr>
                <td>1.3 Number of residents completing their program in year</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Professional Development and Global Fellowship: Collaborate with others to provide faculty development resources online and in face-to-face seminars</b></td>
                </tr>
                <tr >
                <td width="80%" >2.1 Number of faculty participating in CAAP-facilitated faculty development resources in the year</td>
                ...
                <tr>
                <td colspan="2" ><b>3. Help Christian primary care clinicians and academics to find their place of educational service and prepare them for cross-cultural clinical mentoring and discipleship. </b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of faculty contacts being actively facilitated for long term service in the year </td>
                ...
                <table cellpadding="4" style="line-height: 1.7;">
                <tr>
                <td colspan="2" ><b>4. Facilitate Short-Term Teaching Trips: Facilitate visiting consultants and groups to teach in African residency programs.</b></td>
                </tr>
                <tr>
                <td width="80%" >4.1 Number of consultants facilitated for teaching in African residence programs in the year </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c4")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Christian Academy of African Physicians - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Establish new, mainly family medicine residency training programs, over the next 10 years 
Support the development of accredited family medicine or internal medicine-pediatrics residency programs by 2030 </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03"> 1.1 Number of residency programs established (family medicine or internal medicine-paediatrics)</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of residents enrolled at year end</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.3 Number of residents completing their program in year</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Professional Development and Global Fellowship: Collaborate with others to provide faculty development resources online and in face-to-face seminars</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of faculty participating in CAAP-facilitated faculty development resources in the year </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">3. Help Christian primary care clinicians and academics to find their place of educational service and prepare them for cross-cultural clinical mentoring and discipleship. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of faculty contacts being actively facilitated for long term service in the year</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">4. Facilitate Short-Term Teaching Trips: Facilitate visiting consultants and groups to teach in African residency programs.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.1 Number of consultants facilitated for teaching in African residence programs in the year</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=4' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
