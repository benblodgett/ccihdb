...
{    
    $sqlQuery="SELECT * FROM c19  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c19 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c19 set q1_1=" . empty2null($q1_1) . ", q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ", mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c19 (rp,q1_1,q2_1,q2_2,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q2_1) . "," . empty2null($q2_2) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c19 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 1. Strengthen UPMB-accredited health facilities across Uganda to respond to emerging diseases in their catchment population. </b></td>
                </tr>
                <tr >
                <td width="80%" >1.1 Number of UPMB accredited health facilities provided TA on emerging disease management</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Improving governance and leadership to ensure better management and utilization of available resources. Strengthening the Board of Directors and Management Committees incorporating governance principles </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of facilities trained in Leadership and Governance </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>
                <tr>
                <td width="80%" >2.2 Number of trained facilities with functional Boards and committees</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c19")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Uganda Protestant Medical Bureau (UPMB) - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Strengthen UPMB-accredited health facilities across Uganda to respond to emerging diseases in their catchment population. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of UPMB accredited health facilities provided TA on emerging disease management</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Improving governance and leadership to ensure better management and utilization of available resources. Strengthening the Board of Directors and Management Committees incorporating governance principles  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of facilities trained in Leadership and Governance</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of trained facilities with functional Boards and committees </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=19' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
