...
{    
    $sqlQuery="SELECT * FROM c21  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    if(strlen($q11_lv)==0 && strlen($q11_uv)==0 && strlen($q11_tv)==0){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c21 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c21 set q1_1a=" . empty2null($q11_lv) . ",  	q1_1b=" . empty2null($q11_uv) . ", q1_1c=" . empty2null($q11_tv) . ",q1_2a=" . empty2null($q12_lv) . ",q1_2b=" . empty2null($q12_uv) . ",q1_2c=" . empty2null($q12_tv) . ",q1_3=" . empty2null($q1_3) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c21(rp,q1_1a,q1_1b,q1_1c,q1_2a,q1_2b,q1_2c,q1_3,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q11_lv). "," . empty2null($q11_uv) . "," . empty2null($q11_tv) . "," . empty2null($q12_lv) . "," . empty2null($q12_uv) . "," . empty2null($q12_tv) . "," . empty2null($q1_3) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c21 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <tr>
                <td colspan="2" ><b>1. To perform independent assays of pharmaceutical products, site visits of vendors, and strict regulatory adherence and oversight to improve quality of products.       </b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.1 Number or Percentage of facilities having selected essential drugs and supplies in-stock and non-expired <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_1c'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.2 Number or Percentage of entities/facilities having key supplies and equipment  <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_2a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_2b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_2c'].'</b></td>
                </tr>
                <tr >
                <td colspan="2">1.3 Number of treatment days of all medications supplied globally (Human treatment value) <br/>&nbsp;&nbsp;&nbsp;    <b>'.$valu1['q1_3'].'</b>&nbsp;&nbsp;&nbsp;   </td>
                </tr>
                </table>
                </td>
                </tr>                        
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c21")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Blessings International - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. To perform independent assays of pharmaceutical products, site visits of vendors, and strict regulatory adherence and oversight to improve quality of products. <br/> - To provide long expiration dates to assure providers and patients alike have the ability to appropriately utilize pure, safe and effective medicines, while remaining in compliance with various ministries of health.<br/> - To ship safe, pure and effective essential medicines, vitamins and supplies directly to the country of use through coordination with key partners, organizations and governments thereby allowing improved delivery of service to vulnerable stakeholders. <br/> - To track the human treatment value in 100 countries globally. The human treatment value is a unique measurement that quantifies the medication by the number of treatment days                            </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number or Percentage of facilities having selected essential drugs and supplies in-stock and non-expired</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control" id="q11_lv" name="q11_lv" value='<?if(strlen($q11_lv)!=0) echo $q11_lv; else echo $rsmember['q1_1a'];?>' placeholder="Achievement" onblur="q2(form1.q11_lv,form1.q11_uv,form1.q11_tv)"></li>
                                                                <li><input type="text" class="form-control" id="q11_uv" name="q11_uv" value='<?if(strlen($q11_uv)!=0) echo $q11_uv; else echo $rsmember['q1_1b'];?>' placeholder="Target" onblur="q2(form1.q11_lv,form1.q11_uv,form1.q11_tv)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control" id="q11_tv" name="q11_tv"  value='<?if(strlen($q11_tv)!=0) echo $q11_tv; else echo $rsmember['q1_1c'];?>' placeholder="% value" onblur="q2(form1.q11_lv,form1.q11_uv,form1.q11_tv)">
                                                                </div>
                                                            </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number or Percentage of entities/facilities having key supplies and equipment </label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.3 Number of treatment days of all medications supplied globally (Human treatment value)</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=21' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
