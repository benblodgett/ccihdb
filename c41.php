...
{    
    $sqlQuery="SELECT * FROM c41  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if(strlen($q3_1)==0 ){
        ...
        $error =$error."Specify, Indicator 3_1 "."<br/>";
        $errval = true;
    }   
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c41 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c41 set q1_1a=" . empty2null($q11_lv) . ",q1_1b=" . empty2null($q11_uv) . ",q1_1c=" . empty2null($q1_1) . ",q2_1=" . empty2null($q2_1) . ",q3_1=" . empty2null($q3_1) . ", mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c41(rp,q1_1a,q1_1b,q1_1c,q2_1,q3_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q11_lv) . "," . empty2null($q11_uv) . "," . empty2null($q1_1) . "," . empty2null($q2_1) . "," . empty2null($q3_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c41 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>  1. Access to essential medicines Indicators</b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.1 Percentage of facilities having essential drugs in-stock and non-expired (e.g., antibiotics, anthelmintic, contraceptive methods) <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_1c'].'</b></td>
                </tr>
                </table>
                </td>
                </tr>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 2. Leadership and Governance Indicators</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of key documents that are distributed regularly such as budget documents, annual performance reviews, and health indicators</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 3. Service delivery Indicators</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >3.1 Number of activities organized which address basic needs of vulnerable populations</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c41")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Christian Health Association of Nigeria - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Access to essential medicines Indicators</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Percentage of facilities having essential drugs in-stock and non-expired (e.g., antibiotics, anthelmintic, contraceptive methods) </label>
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Leadership and Governance Indicators</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of key documents that are distributed regularly such as budget documents, annual performance reviews, and health indicators </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">3. Service delivery Indicators</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of activities organized which address basic needs of vulnerable populations </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=41' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
