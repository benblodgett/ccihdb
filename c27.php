...
{    
    $sqlQuery="SELECT * FROM c27  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if(strlen($q12_lv)==0 && strlen($q12_uv)==0 && strlen($q1_2)==0 ){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c27 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c27 set q1_1=" . empty2null($q1_1) . ",q1_2a=" . empty2null($q12_lv) . ",q1_2b=" . empty2null($q12_uv) . ",q1_2c=" . empty2null($q1_2) . ",q1_3=" . empty2null($q1_3) . ",q1_4=" . empty2null($q1_4) . ",q1_5=" . empty2null($q1_5) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c27(rp,q1_1,q1_2a,q1_2b,q1_2c,q1_3,q1_4,q1_5,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1) . "," . empty2null($q12_lv) . "," . empty2null($q12_uv) . "," . empty2null($q1_2) . "," . empty2null($q1_3) . "," . empty2null($q1_4) . "," . empty2null($q1_5) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c27 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Train religious leaders (Christian and Muslim), traditional leaders, government leaders, families, teachers, and NGOs as health and justice advocates for children with disabilities. Advocates support children with disabilities via home visits, counseling, monitoring and service referrals. Advocates conduct disability justice sensitization activities in their communities.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number and type of community volunteers trained on health and disability advocacy</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.2 Percent changes in the pre-post test health knowledge and attitude scores of community volunteers<br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_2a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_2b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_2c'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.3 Number of community members served by the community volunteers</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_3'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.4 Number of counseling sessions conducted by the community volunteers</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_4'].'</b></td>
                </tr>
                <tr >
                <td width="80%" >1.5 Number of people sensitized about disability justice through information, education, and communication campaigns</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c27")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Kupenda for the Children - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Train religious leaders (Christian and Muslim), traditional leaders, government leaders, families, teachers, and NGOs as health and justice advocates for children with disabilities. Advocates support children with disabilities via home visits, counseling, monitoring and service referrals. Advocates conduct disability justice sensitization activities in their communities.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number and type of community volunteers trained on health and disability advocacy</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Percent changes in the pre-post test health knowledge and attitude scores of community volunteers</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control " id="q12_lv" name="q12_lv" value='<?if(strlen($q12_lv)!=0) echo $q12_lv; else echo $rsmember['q1_2a'];?>' placeholder="Achievement" onblur="q2(form1.q12_lv,form1.q12_uv,form1.q1_2)"></li>
                                                                <li><input type="text" class="form-control " id="q12_uv" name="q12_uv" value='<?if(strlen($q12_uv)!=0) echo $q12_uv; else echo $rsmember['q1_2b'];?>' placeholder="Target" onblur="q2(form1.q12_lv,form1.q12_uv,form1.q1_2)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control" id="q1_2" name="q1_2" value='<?if(strlen($q1_2)!=0) echo $q1_2; else echo $rsmember['q1_2c'];?>' onblur="q2(form1.q12_lv,form1.q12_uv,form1.q1_2)">
                                                                </div>
                                                            </li>
                                                            </ul>                                                            
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.3 Number of community members served by the community volunteers</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.4 Number of counseling sessions conducted by the community volunteers</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.5 Number of people sensitized about disability justice through information, education, and communication campaigns</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=27' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
