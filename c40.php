...
{    
    $sqlQuery="SELECT * FROM c40  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c40 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c40 set q1_1a=" . empty2null($q11_lv) . ",q1_1b=" . empty2null($q11_uv) . ",q1_1c=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ",q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ",q2_3=" . empty2null($q2_3) . ", mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c40(rp,q1_1a,q1_1b,q1_1c,q1_2,q2_1,q2_2,q2_3,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q11_lv) . "," . empty2null($q11_uv) . "," . empty2null($q1_1) . "," . empty2null($q1_2) . "," . empty2null($q2_1) . "," . empty2null($q2_2) . "," . empty2null($q2_3) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c40 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>  1. Access to Medicines and Supplies Indicators</b></td>
                </tr>
                ...
                <tr >
                <td width="80%" >1.2 Number of SOPs for conducting procurement of equipment and pharmaceuticals</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 2. Community Service Indicators</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of home visits</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr> 
                <tr class="border_bottom">
                <td width="80%" >2.2 Number of information, education, and communication campaigns launched</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_2'].'</b></td>
                </tr> 
                <tr class="border_bottom">
                <td width="80%" >2.3 Number of community members served</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c40")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Association Galle Kisal - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Access to Medicines and Supplies Indicators</span>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of SOPs for conducting procurement of equipment and pharmaceuticals</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Community Service Indicators</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of home visits  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of information, education, and communication campaigns launched </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.3 Number of community members served </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=40' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
