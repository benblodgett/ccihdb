...
{    
    $sqlQuery="SELECT * FROM c7  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c7 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c7 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q2_1=" . empty2null($q2_1) . ",q3_1=" . empty2null($q3_1) . ",q3_2=" . empty2null($q3_2) . ",q4_1=" . empty2null($q4_1) . ",q4_2=" . empty2null($q4_2) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c7(rp,q1_1,q1_2,q2_1,q3_1,q3_2,q4_1,q4_2,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q2_1) . "," . empty2null($q3_1) . "," . empty2null($q3_2) . "," . empty2null($q4_1) . "," . empty2null($q4_2) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c7 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Provide mentorship for its members towards achieving quality accreditation. </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of member organizations provided technical assistance and mentorship for accreditation</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr>
                <td >1.2 Number of member organizations with well-defined QA system that monitors service quality</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Network with FBOs and NGOs for implementing signed PPP contracts with government programs, especially in states where health indicators are poor.  </b></td>
                </tr>
                <tr>
                <td width="80%" >2.1 Number of partnerships initiated with government or development agencies</td>
                ...
                <tr>
                <td colspan="2" ><b>3. Build the capacity of its member institutions to adapt robust documentation processes using technology. CMAI will hold trainings as required.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >3.1 Number of training programs on documentation and health information systems</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q3_1'].'</b></td>
                </tr>   
                <tr >
                <td width="80%" >3.2 Number of individuals trained in documentation and health information systems - 1 programme for 2 weeks</td>
                ...
                <table cellpadding="4" style="line-height: 1.7;">
                <tr>
                <td colspan="2" ><b>4. Leadership and Governance: C capacity building by organizing more workshops and consultations with the hospital and church leadership toward achieving better governance.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >4.1 Number of training programs/workshops conducted on good governance and leadership </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q4_1'].'</b></td>
                </tr>  
                <tr>
                <td width="80%" >4.2 Number of individuals trained in good governance and leadership  </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c7")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Christian Medical Association India (CMAI) - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Provide mentorship for its members towards achieving quality accreditation. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of member organizations provided technical assistance and mentorship for accreditation</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of member organizations with well-defined QA system that monitors service quality</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2.  Network with FBOs and NGOs for implementing signed PPP contracts with government programs, especially in states where health indicators are poor.  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of partnerships initiated with government or development agencies</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">3.  Build the capacity of its member institutions to adapt robust documentation processes using technology.  CMAI will hold trainings as required.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of training programs on documentation and health information systems</label>
                                                            <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.2 Number of individuals trained in documentation and health information systems - 1 programme for 2 weeks</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">4.   Leadership and Governance: C capacity building by organizing more workshops and consultations with the hospital and church leadership toward achieving better governance.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.1 Number of training programs/workshops conducted on good governance and leadership</label>
                                                            <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.2 Number of individuals trained in good governance and leadership - </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=7' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
