...
{    
    $sqlQuery="SELECT * FROM c18  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c18 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c18 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ",q1_3=" . empty2null($q1_3) . ",q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ",q3_1=" . empty2null($q3_1) . ",q4_1a=" . empty2null($q41_lv) . ",q4_1b=" . empty2null($q41_uv) . ",q4_1c=" . empty2null($q4_1) . ", mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c18 (rp,q1_1,q1_2,q1_3,q2_1,q2_2,q3_1,q4_1a,q4_1b,q4_1c,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q1_3) . "," . empty2null($q2_1) . "," . empty2null($q2_2) . "," . empty2null($q3_1) . "," . empty2null($q41_lv) . "," . empty2null($q41_uv) . "," . empty2null($q4_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c18 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 1. Improving utilization of curative and preventive services: Health promotion, Integrating the CHE (community health evangelism) model to train health workers and community health volunteers</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of community-based health promotion activities or information, education, and communication campaigns launched </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.2 Number of people reached through health promotion activities</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_2'].'</b></td>
                </tr>
                <tr>
                <td width="80%" >1.3 Number of health worker’s/community health volunteers trained in Health Promotion</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Improving quality: Capacity building and continuous professional development of health personnel - Updating the knowledge and skills of the nursing staff, Equipping key staff with certain medical skills/procedures needed in their regions as guided by staff requests/needs, Train community health workers to help in disease surveillance </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of nursing staff trained in specific thematic areas </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>
                <tr>
                <td width="80%" >2.2 Number of community health workers trained in disease surveillance and case identification</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>3. Resource mobilization to provide equipment and supplies to smaller health centers </b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of facilities having key supplies and equipment (e.g. gloves, syringes, bandages) </td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>4. Expand and improve on the range and quality of services we provide within five years. o Health education and promotional services for pregnant and lactating mothers to improve pre- and post-natal services.  </b></td>
                </tr>
                <tr>
                <td colspan="2">4.1 Percentage of increase in population coverage for care compared to last year (maternal care, screenings, vaccines, etc.) <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q4_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q4_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q4_1c'].'</b></td>
                </tr>
                </table>
                </td>
                </tr>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c18")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Église Méthodiste du Togo - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Improving utilization of curative and preventive services: Health promotion, Integrating the CHE (community health evangelism) model to train health workers and community health volunteers  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of community-based health promotion activities or information, education, and communication campaigns launched  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of people reached through health promotion activities</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.3 Number of health worker’s/community health volunteers trained in Health Promotion</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Improving quality: Capacity building and continuous professional development of health personnel - Updating the knowledge and skills of the nursing staff,  Equipping key staff with certain medical skills/procedures needed in their regions as guided by staff requests/needs, Train community health workers to help in disease surveillance  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of nursing staff trained in specific thematic areas</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of community health workers trained in disease surveillance and case identification</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">3. Resource mobilization to provide equipment and supplies to smaller health centers </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of facilities having key supplies and equipment (e.g. gloves, syringes, bandages) </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">4. Expand and improve on the range and quality of services we provide within five years. o Health education and promotional services for pregnant and lactating mothers to improve pre- and post-natal services. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.1 Percentage of increase in population coverage for care compared to last year (maternal care, screenings, vaccines, etc.)</label>
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=18' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
