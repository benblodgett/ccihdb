...
! function(CCIH, $) {
    ...
    var $win = $(window),
        $body = $('body'),
        breaks = CCIH.Break; // Messages Variable
    ...
    CCIH.Message = function() {
        function msg_autohide() {
            if (CCIH.Win.width >= flat_break) {
        ...
        function profile_overlay() {
            ...
            if (CCIH.Win.width < info_break && $msg_profile.hasClass('visible')) {
        ...
        function profile_trigger() {
            $toggle_info.on('click', function(e) {
                ...
                if (CCIH.Win.width >= flat_break) {
                    ...
                    } else if (CCIH.Win.width < info_break && !$(this).hasClass('active')) {
        ...
        function msg_on_resize() {
            ...
            if (CCIH.Win.width >= flat_break && CCIH.Win.width < info_break) {
    ...
    CCIH.coms.docReady.push(CCIH.Message);
}(CCIH, jQuery);