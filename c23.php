...
{    
    $sqlQuery="SELECT * FROM c23  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if(strlen($q13_lv)==0 && strlen($q13_uv)==0 && strlen($q1_3)==0 ){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c23 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c23 set q1_1a=" . empty2null($q11_lv) . ", q1_1b=" . empty2null($q11_uv) . ",q1_1c=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ",q1_3a=" . empty2null($q13_lv) . ",q1_3b=" . empty2null($q13_uv) . ", q1_3c=" . empty2null($q1_3) . ",q1_4=" . empty2null($q1_4) . ",q1_5=" . empty2null($q1_5) . ", q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c23(rp,q1_1a,q1_1b,q1_1c,q1_2,q1_3a,q1_3b,q1_3c,q1_4,q1_5,q2_1,q2_2,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q11_lv). "," . empty2null($q11_uv). "," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q13_lv) . "," . empty2null($q13_uv) . "," . empty2null($q1_3) . "," . empty2null($q1_4) . "," . empty2null($q1_5) . "," . empty2null($q2_1) . "," . empty2null($q2_2) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c23 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Train Community Health workers and teachers in hygiene promotion and menstrual hygiene management to support their WASH program activities, which include implementation of hygiene clubs in the community (92 villages) as well as in schools (17 schools). Train Community Health workers to deliver parenting education to support their ECD program. Parenting education is focused on early child development, nutrition, hygiene, health promotion, and income generating activities. </b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.1 Percentage of staff receiving training in key skill areas and having up-to-date skills<br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_1c'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td>1.2 Number of individuals trained on WASH</td>
                <td style="text-align:center;"><b>'.$valu1['q1_2'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.3 Percent of trainees that apply WASH skills to current work<br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_3a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_3b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_3c'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td>1.4 Average days of absenteeism among community health workers compared to geographical average (Please indicate the annual working days)</td>
                <td style="text-align:center;"><b>'.$valu1['q1_4'].'</b></td>
                </tr>
                <tr>
                <td >1.5 Number of people trained on WASH, practicing in the region they were trained</td>
                <td style="text-align:center;"><b>'.$valu1['q1_5'].'</b></td>
                </tr>
                </table>
                </td>
                </tr>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. To implement a Community Early Child Development program in Kamonyi District in Catholic Church covering 6 villages and reaching 435 parents of children under six years old. Through this program, hygiene promotion that emphasizes handwashing, sanitation and safe drinking water is delivered. The ECD program is undertaken at Catholic Churches. Hand washing is emphasized in the nursery schools. To implement a WASH program in Gatsibo District targeted at faith-based schools and public schools. Hygiene promotion and Menstrual Hygiene Management is the focus of this work.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of Schools reached by ECD program</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>
                <tr >
                <td width="80%" >2.2 Number of children attending ECD program </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c23")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Community Fountain Organization - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Train Community Health workers and teachers in hygiene promotion and menstrual hygiene management to support their WASH program activities, which include implementation of hygiene clubs in the community (92 villages) as well as in schools (17 schools). Train Community Health workers to deliver parenting education to support their ECD program. Parenting education is focused on early child development, nutrition, hygiene, health promotion, and income generating activities.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Percentage of staff receiving training in key skill areas and having up-to-date skills</label>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of individuals trained on WASH</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.3 Percent of trainees that apply WASH skills to current work</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control " id="q13_lv" name="q13_lv" value='<?if(strlen($q13_lv)!=0) echo $q13_lv; else echo $rsmember['q1_3a'];?>' placeholder="Achievement" onblur="q2(form1.q13_lv,form1.q13_uv,form1.q1_3)"></li>
                                                                <li><input type="text" class="form-control " id="q13_uv" name="q13_uv" value='<?if(strlen($q13_uv)!=0) echo $q13_uv; else echo $rsmember['q1_3b'];?>' placeholder="Target" onblur="q2(form1.q13_lv,form1.q13_uv,form1.q1_3)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control" id="q1_3" name="q1_3" value='<?if(strlen($q1_3)!=0) echo $q1_3; else echo $rsmember['q1_3c'];?>' onblur="q2(form1.q13_lv,form1.q13_uv,form1.q1_3)">
                                                                </div>
                                                            </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.4 Average days of absenteeism among community health workers compared to geographical average (Please indicate the annual working days)</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.5 Number of people trained  on WASH, practicing in the region they were trained</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. To implement a Community Early Child Development program in Kamonyi District in Catholic Church covering 6 villages and reaching 435 parents of children under six years old. Through this program, hygiene promotion that emphasizes handwashing, sanitation and safe drinking water is delivered. The ECD program is undertaken at Catholic Churches. Hand washing is emphasized in the nursery schools. To implement a WASH program in Gatsibo District targeted at faith-based schools and public schools. Hygiene promotion and Menstrual Hygiene Management is the focus of this work.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of Schools reached  by ECD program</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of children attending ECD program </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=23' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
