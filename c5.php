...
{    
    $sqlQuery="SELECT * FROM c5  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c5 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c5 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q1_3=" . empty2null($q1_3) . ",q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ",q3_1=" . empty2null($q3_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c5(rp,q1_1,q1_2,q1_3,q2_1,q2_2,q3_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q1_3) . "," . empty2null($q2_1) . "," . empty2null($q2_2) . "," . empty2null($q3_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c5 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Registration as a business unit of CHAK; Representation- Kenya Bureau of Standards and Kenyan Govt. Stds committees, Licensing as a technical service provider, Accreditation and certification to provide the biomedical work.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of standards accredited such as relevant ISO certifications and/or additional no. of licences received.</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td >1.2 Number of member facilities received calibration and safety assesment certificates</td>
                <td style="text-align:center;"><b>'.$valu1['q1_2'].'</b></td>
                </tr>
                <tr>
                <td>1.3 Number of facilities served (doing maintenance and calibration works) by new CHAK calibration labs and/or dosimetry labs</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Develop well-trained service staff in installation, maintenance, calibration, safety assessment, and general biomedical engineering work.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of Internal service staff trained and certified for doing calibration works.</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>  
                <tr >
                <td width="80%" >2.2 Number of member facilities staff trained in equipment maintenance, health technology and biomedical engineering </td>
                ...
                <tr>
                <td colspan="2" ><b>3. Work with international partners for equipment donation and procurement logistics for CHAK member facilities </b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of partnerships initiated /engaged </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c5")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Christian Health Association of Kenya (CHAK) - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Registration as a business unit of CHAK; Representation- Kenya Bureau of Standards and Kenyan Govt. Stds committees, Licensing as a technical service provider, Accreditation and certification
                                                            to provide the biomedical work.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of standards accredited such as relevant ISO certifications and/or additional no. of licences received.</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of member facilities received calibration and safety assesment certificates </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.3 Number of facilities served (doing maintenance and calibration works) by new CHAK calibration labs and/or dosimetry labs</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Develop well-trained service staff in installation, maintenance, calibration, safety assessment, and general biomedical engineering work.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of Internal service staff trained and certified for doing calibration works.</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 ">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of member facilities staff trained in equipment maintenance, health technology and biomedical engineering </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">3. Work with international partners for equipment donation and procurement logistics for CHAK member facilities</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of partnerships initiated /engaged</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=5' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
