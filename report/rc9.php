...
//q1_1
    $ageChart="select rp,q1_1 val from c9";
    //echo $ageChart;
    ...
    //q1_2
    $ageChart="select rp,q1_2 val from c9";
    //echo $ageChart;
    $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    if ($ageChartresult) {
        $AgeChartArray = array(
    ...
    //q1_3
    $ageChart="select rp,q1_3 val from c9";
    //echo $ageChart;
    $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    if ($ageChartresult) {
        $AgeChartArray = array(
    ...
    //q2_1
    $ageChart="select rp,q2_1 val from c9";
    //echo $ageChart;
    $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    if ($ageChartresult) {
        $AgeChartArray = array(
    ...
    $ageChartGraph->render();
     ...
     //q2_2
     $ageChart="select rp,q2_2  val from c9";
     //echo $ageChart;
     $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
     if ($ageChartresult) {
         $AgeChartArray = array(
     ...
     $ageChartGraph->render();
      ...
      //q2_3
    $ageChart="select rp,q2_3 val from c9";
    //echo $ageChart;
    $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    if ($ageChartresult) {
        $AgeChartArray = array(
    ...
    $ageChartGraph->render();
     ...
     //q2_4
     $ageChart="select rp,q2_4 val from c9";
     //echo $ageChart;
     $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
     if ($ageChartresult) {
         $AgeChartArray = array(
     ...
     $ageChartGraph->render();
      ...
      //q3_1
    $ageChart="select rp,q2_5 val from c9";
    //echo $ageChart;
    $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    if ($ageChartresult) {
        $AgeChartArray = array(
    ...
    //q4_1
    $ageChart="select rp,q3_1 val from c9";
    //echo $ageChart;
    $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    if ($ageChartresult) {
        $AgeChartArray = array(
                                    ...
                                    <li class="dropdown user-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                <?if($_COOKIE["previ"]=="OA"){?>
                                                    <li><a href="../c9.php"><em class="icon ni ni-list-round"></em><span>Back to the Forms</span></a></li>
                ...
                <form id="form1" name="form1" method="post" action="<?echo $_SERVER['PHP_SELF'] ?>" autocomplete="off" class="form-validate">
                    ...
                    <div class="ccih-block-head">
                                    <div class="ccih-block-head-content">
                                                <h3 class="ccih-block-title page-title"> Dalton Foundation </h3>
                        ...
                        <div class="ccih-block mt-4">
                                        <div class="row g-gs">
                                            <div class="col-md-6  ">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">1.1 Number of health care workers enrolled in the network</div>
                                                    <div class="card-inner is-scrollable h-325px" id="q1_1"> </div> 
                                                </div>
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">1.2 Number of workshops/conferences on leadership or community development conducted</div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6  ">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">1.3 Number of virtual meetings such as webinars, conducted</div>
                                                    <div class="card-inner is-scrollable h-325px" id="q1_3"> </div> 
                                                </div>
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">2.1 Number of rural facilities provided basic diagnostic equipment</div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6  ">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">2.2 Number of larger facilities ensured with standardised common equipment</div>
                                                    <div class="card-inner is-scrollable h-325px" id="q2_2"> </div> 
                                                </div>
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">2.3 Number of nurses receiving diagnostic care kits</div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6  ">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">2.4 Number of physicians receiving diagnostic care kits</div>
                                                    <div class="card-inner is-scrollable h-325px" id="q2_4"> </div> 
                                                </div>
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">2.5 Number of facilities having key supplies and equipment (e.g. gloves, syringes, bandages)</div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6  ">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">3.1 Number of incidents of equipment breakdown/failure that were successfully rectified</div>
