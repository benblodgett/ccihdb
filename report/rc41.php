...
//q1_1
    $ageChart="select rp, q1_1c val from c41";
    //echo $ageChart;
    ...
    //q2_1
    $ageChart="select rp,q2_1 val from c41";
    //echo $ageChart;
    $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    if ($ageChartresult) {
        $AgeChartArray = array(
    ...
    //q3_1
     $ageChart="select rp,q3_1 val from c41";
     //echo $ageChart;
     $ageChartresult = $dbhandle->query($ageChart) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
     if ($ageChartresult) {
         $AgeChartArray = array(
                ...
                <form id="form1" name="form1" method="post" action="<?echo $_SERVER['PHP_SELF'] ?>" autocomplete="off" class="form-validate">
                    ...
                    <div class="ccih-block-head">
                                    <div class="ccih-block-head-content">
                                                <h3 class="ccih-block-title page-title"> Christian Health Association of Nigeria</h3>
                        ...
                        <div class="ccih-block mt-4">
                                        <div class="row g-gs">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">2.1 Number of key documents that are distributed regularly such as budget documents, annual performance reviews, and health indicators </div>
                                        ...
                                        <div class="row g-gs">
                                            <div class="col-md-6  ">
                                                <div class="card card-bordered">
                                                    <div class="card-header border-bottom title">3.1 Number of activities organized which address basic needs of vulnerable populations</div>
