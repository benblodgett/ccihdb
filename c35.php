...
{    
    $sqlQuery="SELECT * FROM c35  WHERE sno='$editQuery'";  
...
if (isset($_POST['sub']) || isset($_POST['sublate'])) {
    $RepPer = $_POST['RepPer'];
    $q1_1_lv = $_POST['q1_1_lv'];
    $q1_1_uv = $_POST['q1_1_uv'];
    $q1_1_tv = $_POST['q1_1_tv'];
...
if($fstat=='Completed'){
    if(strlen($q1_1_lv)==0 && strlen($q1_1_uv)==0 && strlen($q1_1_tv)==0 ){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c35 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c35 set q1_1_1a=" . empty2null($q1_1_lv) . ", q1_1_1b=" . empty2null($q1_1_uv) . ", q1_1_1c=" . empty2null($q1_1_tv) . ",q1_2_1a=" . empty2null($q1_2_lv) . ", 	q1_2_1b=" . empty2null($q1_2_uv) . ",q1_2_1c=" . empty2null($q1_2_tv) . ",q2_1=" . empty2null($q2_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c35(rp,q1_1_1a,q1_1_1b,q1_1_1c,q1_2_1a,q1_2_1b,q1_2_1c,q2_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1_lv). "," . empty2null($q1_1_uv) . "," . empty2null($q1_1_tv) . "," . empty2null($q1_2_lv) . "," . empty2null($q1_2_uv) . "," . empty2null($q1_2_tv) . "," . empty2null($q2_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c35 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Improve the management and accountability of the financial system of the congregation, including 19 health facilities (hospitals, small care centers, and clinics) and a pharmacy depot through training of managers, monitoring and evaluation, and regular reporting </b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.1 Percent of total expenditure on health spent on country priority health services <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_1_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_1_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_1_1c'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.2 Percent of patient population covered by health insurance  <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_2_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_2_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_2_1c'].'</b></td>
                </tr>
                <tr class="border_bottom">
                </tr>
                </table>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Implement numerous training and awareness campaigns on health education, including basic principles of personal and community hygiene (hand washing, drinking water and maintenance of latrines) in order to prevent community outbreaks </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of distinct community-based health activities </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c35")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Le Bon Berger - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Improve the management and accountability of the financial system of the congregation, including 19 health facilities (hospitals, small care centers, and clinics) and a pharmacy depot through training of managers, monitoring and evaluation, and regular reporting</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Percent of total expenditure on health spent on country priority health services</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control " id="q1_1_lv" name="q1_1_lv" value='<?if(strlen($q1_1_lv)!=0) echo $q1_1_lv; else echo $rsmember['q1_1_1a'];?>' placeholder="Achievement" onblur="q1(form1.q1_1_lv,form1.q1_1_uv,form1.q1_1_tv)"></li>
                                                                <li><input type="text" class="form-control " id="q1_1_uv" name="q1_1_uv" value='<?if(strlen($q1_1_uv)!=0) echo $q1_1_uv; else echo $rsmember['q1_1_1b'];?>' placeholder="Target" onblur="q1(form1.q1_1_lv,form1.q1_1_uv,form1.q1_1_tv)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control " id="q1_1_tv" name="q1_1_tv" value='<?if(strlen($q1_1_tv)!=0) echo $q1_1_tv; else echo $rsmember['q1_1_1c'];?>' placeholder="% value" onblur="q1(form1.q1_1_lv,form1.q1_1_uv,form1.q1_1_tv)">
                                                                </div>
                                                            </li>
                                                            </ul>                                                           
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Percent of patient population covered by health insurance</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control " id="q1_2_lv" name="q1_2_lv" value='<?if(strlen($q1_2_lv)!=0) echo $q1_2_lv; else echo $rsmember['q1_2_1a'];?>' placeholder="Achievement" onblur="q1(form1.q1_2_lv,form1.q1_2_uv,form1.q1_2_tv)"></li>
                                                                <li><input type="text" class="form-control " id="q1_2_uv" name="q1_2_uv" value='<?if(strlen($q1_2_uv)!=0) echo $q1_2_uv; else echo $rsmember['q1_2_1b'];?>' placeholder="Target" onblur="q1(form1.q1_2_lv,form1.q1_2_uv,form1.q1_2_tv)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control " id="q1_2_tv" name="q1_2_tv" value='<?if(strlen($q1_2_tv)!=0) echo $q1_2_tv; else echo $rsmember['q1_2_1c'];?>' placeholder="% value" onblur="q1(form1.q1_2_lv,form1.q1_2_uv,form1.q1_2_tv)">
                                                                </div>
                                                            </li>
                                                            </ul>
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Implement numerous training and awareness campaigns on health education, including basic principles of personal and community hygiene (hand washing, drinking water and maintenance of latrines) in order to prevent community outbreaks</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1  Number of distinct community-based health activities</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=35' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
