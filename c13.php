...
{    
    $sqlQuery="SELECT * FROM c13  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c13 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c13 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q2_1=" . empty2null($q2_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c13 (rp,q1_1,q1_2,q2_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q2_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c13 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Identify specific opportunities to partner with ACHAP and member CHAs, aiming to leverage their unique assets and increase their impact and visibility as vital actors in health promotion and service delivery.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of ACHAP member institutions receiving capacity strengthening support (technical assistance and/or funding) for project development, management, implementation, and/or evaluation.  </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr>
                <td width="80%" >1.2 Number of individuals trained or mentored in organizational development or technical skills</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Provide technical assistance and/or funding to CHAs to engage in high-priority interventions that meet local needs and build institutional or technical capacity.</b></td>
                </tr>
                <tr >
                <td width="80%" >2.1 Number of products co-developed/implemented by IMA and ACHAP/member CHAs (ex. proposals, educational or behaviour change communications materials, trainings, etc)</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c13")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> IMA World Health - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="RepPer" name="RepPer" data-placeholder="Select a option" required>
                                                                        ...
                                                                        <option value="July 2018 - June 2019" >July 2018 - June 2019</option>
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Identify specific opportunities to partner with ACHAP and member CHAs, aiming to leverage their unique assets and increase their impact and visibility as vital actors in health promotion and service delivery.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of ACHAP member institutions receiving capacity strengthening support (technical assistance and/or funding) for project development, management, implementation, and/or evaluation.   </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of individuals trained or mentored in organizational development or technical skills</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Provide technical assistance and/or funding to CHAs to engage in high-priority interventions that meet local needs and build institutional or technical capacity.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of products co-developed/implemented by IMA and ACHAP/member CHAs (ex. proposals, educational or behaviour change communications materials, trainings, etc)</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=13' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
