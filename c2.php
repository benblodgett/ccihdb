...
{    
    $sqlQuery="SELECT * FROM c2  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c2 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c2 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ",q2_3=" . empty2null($q2_3) . ",q3_1=" . empty2null($q3_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c2(rp,q1_1,q1_2,q2_1,q2_2,q2_3,q3_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q2_1) . "," . empty2null($q2_2) . "," . empty2null($q2_3) . "," . empty2null($q3_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c2 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Connect mission hospitals with supplies of wheelchairs and other supplies for people with disabilities </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of faith-based medical organizations with more than five conversations and interactions with AT Catalyst - wheelchairs and other supplies </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr>
                <td>1.2 Number of faith-based medical organizations interacting with AT Catalyst who have consequently obtained wheelchairs and other assistive technology</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Provide training to parents and community health workers to bring whole person care for those with disabilities and their families. Train health care workers and religious leaders to ensure wheelchairs are properly fit for each person. Facilitate training for pastors and chaplains to encourage spiritual and social care and inclusion </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of faith-based medical organizations and other faith based initiatives which have implemented training for staff in wheelchair provision</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.2 Number of faith-based medical organizations who have initiated training for parents of children with disability </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_2'].'</b></td>
                </tr>
                <tr>
                <td>2.3 Number of faith-based medical organizations who have initiated training for pastors and chaplains on caring for those with disabilities </td>
                ...
                <tr>
                <td colspan="2" ><b>3. Link mission hospitals with initial start-up funds for these programs</b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of mission hospitals linked with initial start-up funds for the disability program </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c2")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Assistive Technology Catalyst Project with IDEAS - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Connect mission hospitals with supplies of wheelchairs and other supplies for people with disabilities</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of faith-based medical organizations with more than five conversations and interactions with AT Catalyst - wheelchairs and other supplies</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of faith-based medical organizations interacting with AT Catalyst who have consequently obtained wheelchairs and other assistive technology</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Provide training to parents and community health workers to bring whole person care for those with disabilities and their families.
Train health care workers and religious leaders to ensure wheelchairs are properly fit for each person.
Facilitate training for pastors and chaplains to encourage spiritual and social care and inclusion </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1  Number of faith-based medical organizations and other faith based  initiatives which have implemented training for staff in wheelchair provision</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of faith-based medical organizations who have initiated training for parents of children with disability </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 ">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.3 Number of faith-based medical organizations who have initiated training for pastors and chaplains on caring for those with disabilities </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">3. Link mission hospitals with initial start-up funds for these programs</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of mission hospitals linked with initial start-up funds for the disability program.</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=2' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
