...
{    
    $sqlQuery="SELECT * FROM c9  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c9 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c9 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ",q1_3=" . empty2null($q1_3) . ", q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ",q2_3=" . empty2null($q2_3) . ",q2_4=" . empty2null($q2_4) . ",q2_5=" . empty2null($q2_5) . ",q3_1=" . empty2null($q3_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c9 (rp,q1_1,q1_2,q1_3,q2_1,q2_2,q2_3,q2_4,q2_5,q3_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q1_3) . "," . empty2null($q2_1) . "," . empty2null($q2_2) . "," . empty2null($q2_3) . "," . empty2null($q2_4) . "," . empty2null($q2_5) . "," . empty2null($q3_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c9 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Bringing together the healthcare professionals from around the nation to provide community, encourage leadership development, and share best practices. </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of health care workers enrolled in the network  </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td >1.2 Number of workshops/conferences on leadership or community development conducted </td>
                <td style="text-align:center;"><b>'.$valu1['q1_2'].'</b></td>
                </tr>
                <tr>
                <td >1.3 Number of virtual meetings such as webinars, conducted </td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Design strategic projects that affect the health care system. Medical Equipment Modernization and Standardization Program in Northern Haiti. Working with the Department heads for MOH in the Nord and Nord Est departments, they are not only providing much-needed basic diagnostic equipment like otoscopes, pulse ox units, and sphygmomanometers to the rural facilities but are also working with larger facilities to standardize common equipment throughout the region.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of rural facilities provided basic diagnostic equipment  </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>  
                <tr class="border_bottom">
                <td width="80%" >2.2 Number of larger facilities ensured with standardised common equipment </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_2'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.3 Number of nurses receiving diagnostic care kits </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_3'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.4 Number of physicians receiving diagnostic care kits</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_4'].'</b></td>
                </tr>
                <tr>
                <td width="80%" >2.5 Number of facilities having key supplies and equipment (e.g. gloves, syringes, bandages)</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_5'].'</b></td>
                </tr>
                </table>
                </td>
                </tr>
                ...
                <tr>
                <td colspan="2" ><b>3. Training and maintenance hub in Northern Haiti that will house parts and spare units to minimize equipment downtown</b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of incidents of equipment breakdown/failure that were successfully rectified</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c9")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Dalton Foundation - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Bringing together the healthcare professionals from around the nation to provide community, encourage leadership development, and share best practices. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1  Number of health care workers enrolled in the network </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2  Number of workshops/conferences on leadership or community development conducted</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.3  Number of virtual meetings such as webinars, conducted </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Design strategic projects that affect the health care system. Medical Equipment Modernization and Standardization Program in Northern Haiti. Working with the Department heads for MOH in the Nord and Nord Est departments, they are not only providing much-needed basic diagnostic equipment like otoscopes, pulse ox units, and sphygmomanometers to the rural facilities but are also working with larger facilities to standardize common equipment throughout the region. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of rural facilities provided basic diagnostic equipment </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of larger facilities ensured with standardised common equipment  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.3 Number of nurses receiving diagnostic care kits</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.4 Number of physicians receiving diagnostic care kits</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.5 Number of facilities having key supplies and equipment (e.g. gloves, syringes, bandages) </label>
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="q2_5" name="q2_5" value='<?if(strlen($q2_5)!=0) echo $q2_5; else echo $rsmember['q2_5'];?>'>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">3. Training and maintenance hub in Northern Haiti that will house parts and spare units to minimize equipment downtown</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of incidents of equipment breakdown/failure that were successfully rectified</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=9' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
