...
{    
    $sqlQuery="SELECT * FROM c15  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c15 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c15 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q2_1=" . empty2null($q2_1) . ",q2_2a=" . empty2null($q22_lv) . ",q2_2b=" . empty2null($q22_uv) . ",q2_2c=" . empty2null($q2_2) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c15 (rp,q1_1,q1_2,q2_1,q2_2a,q2_2b,q2_2c,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q2_1) . "," . empty2null($q22_lv) . "," . empty2null($q22_uv) . "," . empty2null($q2_2) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c15 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 1. Training the health workforce: RHS will train mid- and low-level staff at the Sudan United Mission School of Health Technology’s Community Health Department and the eight Sudan United Mission Hospitals in Ebonyi State. The training results in a diploma in community health for extension workers, or a certificate in community health. The training will reach workers where they are deployed to stop attrition rates and increase awareness and skills in villages </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of Community-health extension workers and health assistants trained (obtained diploma or certificate)</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr>
                <td width="80%" >1.2 Annual staff attrition rate in the targeted facilities (average of all facilities)</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Training will increase the number of available skilled birth attendants (SBA), which will in turn increase the number of deliveries attended by an SBA. </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of deliveries attended by the trained SBA </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>
                <tr >
                <td colspan="2">2.2 Percentage increase in deliveries attended by trained SBA (if denominator known) <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q2_2a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q2_2b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q2_2c'].'</b></td>
                </tr>
                </table>
                </td>
                </tr>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c15")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Rural Health Services (RHS) of Sudan  - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Training the health workforce: RHS will train mid- and low-level staff at the Sudan United Mission School of Health Technology’s Community Health Department and the eight Sudan United Mission Hospitals in Ebonyi State. The training results in a diploma in community health for extension workers, or a certificate in community health. The training will reach workers where they are deployed to stop attrition rates and increase awareness and skills in villages</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of Community-health extension workers and health assistants trained (obtained diploma or certificate)</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Annual staff attrition rate in the targeted facilities (average of all facilities</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Training will increase the number of available skilled birth attendants (SBA), which will in turn increase the number of deliveries attended by an SBA.  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of deliveries attended by the trained SBA </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Percentage increase in deliveries attended by trained SBA (if denominator known)</label>
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=15' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
