...
{    
    $sqlQuery="SELECT * FROM c12  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c12 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c12 set q1_1=" . empty2null($q1_1) . ", q2_1=" . empty2null($q2_1) . ",q3_1=" . empty2null($q3_1) . ",q4_1=" . empty2null($q4_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c12 (rp,q1_1,q2_1,q3_1,q4_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q2_1) . "," . empty2null($q3_1) . "," . empty2null($q4_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c12 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Solicit partnership with the National Health Insurance Scheme: To ensure that urban poor, especially pregnant women and children under the age of 5, have access to services and do not depend on out-of-pocket payments</b></td>
                </tr>
                <tr>
                <td width="80%" >1.1 Number of individuals/families enrolled in the National Health Insurance Scheme </td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Establish a Community Health Adoption Project (CHAP): HHF will establish Community Mutual Health Associations. </b></td>
                </tr>
                <tr >
                <td width="80%" >2.1 Number of Community Mutual Health Associations established</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>3. Partner with neighbouring institutions to train community-health extension workers and health facility staff in MNCH services to bridge gaps at grassroots levels. </b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of community-health extension workers and health facility staff trained in MNCH services</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 4. Equip primary health care centers with renovation of infrastructure.</b></td>
                </tr>
                <tr>
                <td width="80%" >4.1 Number of primary health care centres that benefitted from medicines, technology</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c12")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Hezekiah Health Foundation - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Solicit partnership with the National Health Insurance Scheme:  To ensure that urban poor, especially pregnant women and children under the age of 5, have access to services and do not depend on out-of-pocket payments</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of individuals/families enrolled in the National Health Insurance Scheme </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Establish a Community Health Adoption Project (CHAP):  HHF will establish Community Mutual Health Associations. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of Community Mutual Health Associations established</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">3. Partner with neighbouring institutions to train community-health extension workers and health facility staff in MNCH services to bridge gaps at grassroots levels. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of community-health extension workers and health facility staff trained in MNCH services</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">4. Equip primary health care centers with renovation of infrastructure. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.1 Number of primary health care centres that benefitted from medicines, technology, </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=12' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
