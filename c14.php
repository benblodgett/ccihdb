...
{    
    $sqlQuery="SELECT * FROM c14  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c14 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c14 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q2_1=" . empty2null($q2_1) . ",q2_2=" . empty2null($q2_2) . ",q3_1=" . empty2null($q3_1) . ",q3_2=" . empty2null($q3_2) . ",q4_1=" . empty2null($q4_1) . ", q5_1=" . empty2null($q5_1) . ", q5_2=" . empty2null($q5_2) . ", q6_1=" . empty2null($q6_1) . ",q6_2=" . empty2null($q6_2) . ",q7_1=" . empty2null($q7_1) . ",q7_2=" . empty2null($q7_2) . ",q8_1='$q8_1',mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c14 (rp,q1_1,q1_2,q2_1,q2_2,q3_1,q3_2,q4_1,q5_1,q5_2,q6_1,q6_2,q7_1,q7_2,q8_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q2_1) . "," . empty2null($q2_2) . "," . empty2null($q3_1) . "," . empty2null($q3_2) . "," . empty2null($q4_1) . "," . empty2null($q5_1). "," . empty2null($q5_2) . "," . empty2null($q6_1) . "," . empty2null($q6_2) . "," . empty2null($q7_1) . "," . empty2null($q7_2) . ",'$q8_1','$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c14 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
	            <tr>
                <td colspan="2" ><b>5. LifeNet seeks out opportunities to collaborate with third-party equipment donors to provide subsets of healthcare facilities with essential medical equipment and supplies </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >5.1 Number of facilities having essential drugs in-stock and nonexpired (e.g., antibiotics, anthelmintic, contraceptive methods) </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q5_1'].'</b></td>
                </tr>
                <tr>
                <td width="80%" >5.2 Number of facilities having key supplies and equipment (e.g. gloves, syringes, bandages)</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>6. LifeNet provides four modules of training in financial, human resources, and administrative best practices that address leading causes of financial instability and insolvency. </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >6.1 Financial health: Total revenue/Total costs   </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q6_1'].'</b></td>
                </tr>
                <tr >
                <td width="80%" >6.2  Existence of financial management systems, systems of accountancy, and regular auditing  </td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>7. LifeNet provides five modules of interactive and hands-on training and mentoring in clinical best practices </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >7.1 Number of trainings completed  </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q7_1'].'</b></td>
                </tr>
                <tr >
                <td width="80%" >7.2 Number of individuals trained  </td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>8. LifeNet provides mentoring and coaching to staff in each partner health facility, offering supportive supervision to health workers to augment the training they receive. </b></td>
                </tr>
                <tr >
                <td width="80%" >8.1 Annual numbers of inpatients/outpatients treated  </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c14")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> LifeNet International - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Medical training programs that provide systems and guidelines for pharmacy management </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of pharmacy trainings conducted </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of individuals trained in pharmacy management</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Training on protocols for care for newborns, mothers, and children for both emergency and routine care. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of trainings in maternal and neonatal health  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Number of  individuals trained in maternal and neonatal health  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">3. Management training programs promote financial sustainability and accountability</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of trainings in financial management and accounting </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.2 Number of  individuals trained in financial management and accounting  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">4. Essential healthcare materials are provided to all partners to ensure basic levels of nursing care can be provided at each LifeNet partner facility. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.1 Number of health facilities provided with essential health care equipment and supplies.  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">5. LifeNet seeks out opportunities to collaborate with third-party equipment donors to provide subsets of healthcare facilities with essential medical equipment and supplies </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">5.1 Number of facilities having essential drugs in-stock and nonexpired (e.g., antibiotics, anthelmintic, contraceptive methods)</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">5.2 Number of facilities having key supplies and equipment (e.g. gloves, syringes, bandages)</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">6. LifeNet provides four modules of training in financial, human resources, and administrative best practices that address leading causes of financial instability and insolvency. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">6.1 Financial health: Total revenue/Total costs   </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">6.2 Existence of financial management systems, systems of accountancy, and regular auditing  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">7. LifeNet provides five modules of interactive and hands-on training and mentoring in clinical best practices</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">7.1 Number of trainings completed  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">7.2 Number of individuals trained  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">8. LifeNet provides mentoring and coaching to staff in each partner health facility, offering supportive supervision to health workers to augment the training they receive. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">8.1 Annual numbers of inpatients/outpatients treated  </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=14' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
