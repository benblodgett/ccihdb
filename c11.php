...
{    
    $sqlQuery="SELECT * FROM c11  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c11 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c11 set q1_1=" . empty2null($q1_1) . ", q2_1=" . empty2null($q2_1) . ",q3_1=" . empty2null($q3_1) . ",q4_1=" . empty2null($q4_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c11 (rp,q1_1,q2_1,q3_1,q4_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q2_1) . "," . empty2null($q3_1) . "," . empty2null($q4_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c11 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Increase the number of Christian U.S.-trained healthcare professionals serving full-time in clinical and community global health by at least 50</b></td>
                </tr>
                <tr>
                <td width="80%" >1.1 Number of health professionals serving with ABC at Years End.</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Increase the number of national healthcare professionals ABC mentors and contribute to training 1,000 annually.</b></td>
                </tr>
                <tr >
                <td width="80%" >2.1 Number of national health professionals trained both informally & formally by ABC international staff members</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>3. Equip at least 1,000 people through the training center, and facilitate at least 5 training programs in international locations before 2030.</b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of participants taught through the Training Center</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>4. Equip at least 1,000 people at the training center, and facilitate at least 5 training programs in international locations before 2030.</b></td>
                </tr>
                <tr>
                <td width="80%" >4.1 Number of Training Programs conducted outside of the United States</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c11")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Health Services Corps - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Increase the number of Christian U.S.-trained healthcare professionals serving full-time in clinical and community global health by at least 50</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of health professionals serving with ABC at Years End.</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Increase the number of national healthcare professionals ABC mentors and contribute to training 1,000 annually.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of national health professionals trained both informally & formally by ABC international staff members</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">3. Equip at least 1,000 people through the training center, and facilitate at least 5 training programs in international locations before 2030.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of participants taught through the Training Center</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">4. Equip at least 1,000 people at the training center, and facilitate at least 5 training programs in international locations before 2030.</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.1 Number of Training Programs conducted outside of the United States</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=11' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
