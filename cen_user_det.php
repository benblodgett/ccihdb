...
if (isset($_POST['sub'])) {
    ...
    if(strlen($cname)==0 || strlen($cid)==0 ){

        $error ="Invalid center name. Please re-login"."<br/>";;
        $errval = true;
    }
    if(strlen($eid)==0 ){
    ...
    if ( $errval != true ) {
        ...
        if( mysqli_num_rows($result) > 0){
            $error="This email id is already registered. Please provide non-existing id  "."<br/>";           
                ...
                $sqlQuery1="Insert into members(center_id,center_name,name,designation,pri_email,off_address,mobile1,fax,previlege,suspended) values ('$cid','$cname','$uname','$Design','$eid','$uadd','$ucontact','$ufax','$prev','$sacc') ";
    ...
    {
        $sqlQuery1="update members set center_id='$cid',center_name='$cname', name='$uname', designation='$Design', pri_email='$eid', off_address='$uadd', mobile1='$ucontact', fax='$ufax', previlege='$prev', suspended='$sacc' where uid='$uid' ";
        $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                if($result1)
                                                   ...
                                                   <div class="col-sm-12 mb-3">
                                                      ...
                                                      <div class="col-md-12 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <ul class="custom-control-group g-3 align-center">
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" class="custom-control-input" value="0" name="sacc" id="fstat21" required "<?php  if ($rsmember['suspended']=="0" || $sacc=="0" || $sacc=='') {echo " checked =\"yes\"";} ?>">
                                                    ...
                                                    <div class="col-sm-12 mb-3 row">                                                    
                                                        ...
                                                        <div class="form-group text-right col-sm-8">
                                                            ...
                                                            <a class="btn btn-lg btn-danger text-white" href=<?="c".$_COOKIE["cid"].".php"?> >Exit</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!--  -->
                                                        ...
                                                        <tbody>
                                                         <?
                                                            $sqlQuery="SELECT * FROM members where previlege='User' and center_id='$cid'  ";  
                                                             $pickQuery=mysqli_query($CCIHCon,$sqlQuery)or die("Unable connect to the table");
                                                         ...
                                                         ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><a href="cen_user_det.php?e=<?=bin2hex($listdata['uid']);?>" ><em class="icon ni ni-edit h6"></em></a></td>
                                                                <td class="text-center"><a href="cen_user_det.php?d=<?=bin2hex($listdata['uid']);?>" ><em class="icon ni ni-trash-alt h6"></em></a></td>
                                                            </tr>
                                                            <? } ?>
