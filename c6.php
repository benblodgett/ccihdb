...
{    
    $sqlQuery="SELECT * FROM c6  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if(strlen($q21_lv)==0 && strlen($q21_uv)==0 && strlen($q2_1)==0 ){

        $error =$error."Specify, Indicator 2.1 "."<br/>";
        $errval = true;
    }    
    if(strlen($q31_lv)==0 && strlen($q31_uv)==0 && strlen($q3_1)==0 ){

        $error =$error."Specify, Indicator 3.1 "."<br/>";
        $errval = true;
    }
    if(strlen($q32_lv)==0 && strlen($q32_uv)==0 && strlen($q3_2)==0 ){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c6 WHERE  rp='$RepPer'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c6 set q1_1a=" . empty2null($q11_lv) . ",q1_1b=" . empty2null($q11_uv) . ",q1_1c=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q2_1a=" . empty2null($q21_lv) . ",q2_1b=" . empty2null($q21_uv) . ",q2_1c=" . empty2null($q2_1) . ",q3_1a=" . empty2null($q31_lv) . ",q3_1b=" . empty2null($q31_uv) . ",q3_1c=" . empty2null($q3_1) . ",q3_2a=" . empty2null($q32_lv) . ",q3_2b=" . empty2null($q32_uv) . ",q3_2c=" . empty2null($q3_2) . ",q4_1=" . empty2null($q4_1) . ",q5_1=" . empty2null($q5_1) . ",q5_2=" . empty2null($q5_2) . ",q6_1=" . empty2null($q6_1) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c6(rp,q1_1a,q1_1b,q1_1c,q1_2,q2_1a,q2_1b,q2_1c,q3_1a,q3_1b,q3_1c,q3_2a,q3_2b,q3_2c,q4_1,q5_1,q5_2,q6_1,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q11_lv). "," . empty2null($q11_uv). "," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q21_lv) . "," . empty2null($q21_uv) . "," . empty2null($q2_1) . "," . empty2null($q31_lv) . "," . empty2null($q31_uv) . "," . empty2null($q3_1) . "," . empty2null($q32_lv) . "," . empty2null($q32_uv) . "," . empty2null($q3_2) . "," . empty2null($q4_1) . "," . empty2null($q5_1) . "," . empty2null($q5_2) . "," . empty2null($q6_1) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c6 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Strengthen staff recruitment and retention (focused on a few facilities at first)</b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">1.1 Percentage of health care positions filled in the chosen facilities (average of all facilities)<br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q1_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q1_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q1_1c'].'</b></td>
                </tr>
                <tr>
                <td >1.2 Annual staff turnover rate (%) in the chosen facilities (average of all facilities)</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>2. Strengthen recruitment and increase intake of students in CHAM training colleges especially cadres that are scarce on the market (focused on a few facilities at first). </b></td>
                </tr>
                <tr>
                <td colspan="2">2.1 Percentage of increase in student’s intake in the chosen facilities (average of all facilities)<br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q2_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q2_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q2_1c'].'</b></td>
                </tr>  
                </table>
                </td>
                </tr>
                ...
                <tr>
                <td colspan="2" ><b>3. Strengthen data reporting systems in training colleges and in health facilities. Monitor how facilities enter data into the national Health Management Information System. </b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">2.1 Percentage of facilities regularly reporting in the national Health Management Information System<br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q3_1a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q3_1b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q3_1c'].'</b></td>
                </tr>   
                <tr >
                <td colspan="2">2.1 Percentage of facilities having clear standards and guidelines for: 1) data collection, 2) reporting procedures methods, and 3) data analysis to be performed)<br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q3_2a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q3_2b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q3_2c'].'</b></td>
                </tr>               
                </table>
                </td>
                </tr>  
                ...
                <table cellpadding="4" style="line-height: 1.7;">
                <tr>
                <td colspan="2" ><b>4. Organize interface meetings with the leadership of various facilities to discuss pertinent issues affecting their facilities. </b></td>
                </tr>
                <tr>
                <td width="80%" >4.1 Number of interface meetings for leaders, conducted in the last year </td>
                ...
                <table cellpadding="4" style="line-height: 1.7;">
                <tr>
                <td colspan="2" ><b>5. Organize capacity building training for the leaders of various facilities </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >5.1 Number of training programs/workshops on Leadership and Governance  </td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q5_1'].'</b></td>
                </tr>   
                <tr>
                <td width="80%" >5.2 Number of individuals trained in Leadership and Governance.   </td>
                ...
                <table cellpadding="4" style="line-height: 1.7;">
                <tr>
                <td colspan="2" ><b>6. Cordinate faith-based HIV initiatives targeting different congregations.  </b></td>
                </tr>
                <tr>
                <td width="80%" >6.1 Number of churches or local church groups (e.g. small or cell groups) involved in health-related community activities</td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c6")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Christian Health Association of Malawi (CHAM) - Quantitative </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Strengthen staff recruitment and retention (focused on a few facilities at first)</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03"> 1.1  Percentage of health care positions filled in the chosen facilities (average of all facilities)</label>
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Annual staff turnover rate (%) in the chosen facilities (average of all facilities)</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>   
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Strengthen recruitment and increase intake of students in CHAM training colleges especially cadres that are scarce on the market (focused on a few facilities at first). </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Percentage of increase in student’s intake in the chosen facilities (average of all facilities)</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control" id="q21_lv" name="q21_lv" value='<?if(strlen($q21_lv)!=0) echo $q21_lv; else echo $rsmember['q2_1a'];?>' placeholder="Achievement" onblur="q2(form1.q21_lv,form1.q21_uv,form1.q2_1)"></li>
                                                                <li><input type="text" class="form-control" id="q21_uv" name="q21_uv" value='<?if(strlen($q21_uv)!=0) echo $q21_uv; else echo $rsmember['q2_1b'];?>' placeholder="Target" onblur="q2(form1.q21_lv,form1.q21_uv,form1.q2_1)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control" id="q2_1" name="q2_1" value='<?if(strlen($q2_1)!=0) echo $q2_1; else echo $rsmember['q2_1c'];?>' onblur="q2(form1.q21_lv,form1.q21_uv,form1.q2_1)">
                                                                </div>
                                                            </li>
                                                            </ul>   
                                                        </div>
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">3. Strengthen data reporting systems in training colleges and in health facilities. Monitor how facilities enter data into the national Health Management Information System.  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1  Percentage  of facilities regularly reporting in the national Health Management Information System</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control" id="q31_lv" name="q31_lv" value='<?if(strlen($q31_lv)!=0) echo $q31_lv; else echo $rsmember['q3_1a'];?>' placeholder="Achievement" onblur="q2(form1.q31_lv,form1.q31_uv,form1.q3_1)"></li>
                                                                <li><input type="text" class="form-control" id="q31_uv" name="q31_uv" value='<?if(strlen($q31_uv)!=0) echo $q31_uv; else echo $rsmember['q3_1b'];?>' placeholder="Target" onblur="q2(form1.q31_lv,form1.q31_uv,form1.q3_1)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control" id="q3_1" name="q3_1" value='<?if(strlen($q3_1)!=0) echo $q3_1; else echo $rsmember['q3_1c'];?>' onblur="q2(form1.q31_lv,form1.q31_uv,form1.q3_1)">
                                                                </div>
                                                            </li>
                                                            </ul>  
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.2  Percentage  of facilities having clear standards and guidelines for: 1) data collection, 2) reporting procedures methods, and 3) data analysis to be performed)</label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control" id="q32_lv" name="q32_lv" value='<?if(strlen($q32_lv)!=0) echo $q32_lv; else echo $rsmember['q3_2a'];?>' placeholder="Achievement" onblur="q2(form1.q32_lv,form1.q32_uv,form1.q3_2)"></li>
                                                                <li><input type="text" class="form-control" id="q32_uv" name="q32_uv" value='<?if(strlen($q32_uv)!=0) echo $q32_uv; else echo $rsmember['q3_2b'];?>' placeholder="Target" onblur="q2(form1.q32_lv,form1.q32_uv,form1.q3_2)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                <input type="text" class="form-control" id="q3_2" name="q3_2" value='<?if(strlen($q3_2)!=0) echo $q3_2; else echo $rsmember['q3_2c'];?>' onblur="q2(form1.q32_lv,form1.q32_uv,form1.q3_2)">
                                                                </div>
                                                            </li>
                                                            </ul>  
                                                            </div>
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">4. Organize interface meetings with the leadership of various facilities to discuss pertinent issues affecting their facilities. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.1 Number of interface meetings for leaders, conducted in the last year</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">5. Organize capacity building training for the leaders of various facilities  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">5.1 Number of training programs/workshops on Leadership and Governance </label>
                                                            <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">5.2 Number of individuals trained in Leadership and Governance.  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">6. Cordinate faith-based HIV initiatives targeting different congregations.  </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">6.1 Number of churches or local church groups (e.g. small or cell groups) involved in health-related community activities</label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?> 
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=6' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
