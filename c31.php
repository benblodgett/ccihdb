...
{    
    $sqlQuery="SELECT * FROM c31  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if(strlen($q22_lv)==0 && strlen($q22_uv)==0  && strlen($q2_2)==0 ){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c31 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c31 set q1_1=" . empty2null($q1_1) . ", q1_2=" . empty2null($q1_2) . ", q2_1=" . empty2null($q2_1) . ",q2_2a=" . empty2null($q22_lv) . ",q2_2b=" . empty2null($q22_uv) . ",q2_2c=" . empty2null($q2_2) . ",q3_1=" . empty2null($q3_1) . ",q4_1=" . empty2null($q4_1) . ",q4_2=" . empty2null($q4_2) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c31(rp,q1_1,q1_2,q2_1,q2_2a,q2_2b,q2_2c,q3_1,q4_1,q4_2,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1). "," . empty2null($q1_2) . "," . empty2null($q2_1) . "," . empty2null($q22_lv) . "," . empty2null($q22_uv) . "," . empty2null($q2_2) . "," . empty2null($q3_1) . "," . empty2null($q4_1) . "," . empty2null($q4_2) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c31 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>1. Improve hospital management (training and systems improvements in finance, HR, and inventory). </b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of mission hospitals, that benefitted from Technical assistance provided by AMH.</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr>
                <td>1.2 Number of individuals supported through AMH Technical Assistance </td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 2. Improve access and utilization of sponsored safe surgeries through WATSI and Surgical Access for Everyone (SAFE), an online platform that enables people to support surgeries for those who cannot afford them.</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of surgeries performed through WATSI and Surgical Access for Everyone (SAFE)</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td colspan="2">2.2 Percentage of increase in the number of surgeries performed through WATSI and Surgical Access for Everyone (SAFE) (if there is baseline info)  <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q2_2a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q2_2b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q2_2c'].'</b></td>
                </tr>
                </table>
                </td>
                </tr>
                ...
                <tr>
                <td colspan="2" ><b>3. Hospital infrastructure grants and sustainability consultations</b></td>
                </tr>
                <tr>
                <td width="80%" >3.1 Number of Infrastructure projects supported. </td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 4. Increase the numbers of health workers and train the future health workforce</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >4.1 Total number of trainees (of all types of training)</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q4_1'].'</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >4.2 Number of individuals graduated from the training programs. </td>
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c31")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> African Mission Healthcare - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 mb-1">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Improve hospital management (training and systems improvements in finance, HR, and inventory).</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">

                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1  Number of mission hospitals, that benefitted from Technical assistance provided by AMH.</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of individuals supported through AMH Technical Assistance  </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Improve access and utilization of sponsored safe surgeries through WATSI and Surgical Access for Everyone (SAFE), an online platform that enables people to support surgeries for those who cannot afford them. </span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of surgeries performed through WATSI and Surgical Access for Everyone (SAFE)</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Percentage of increase in the number of surgeries performed through WATSI and Surgical Access for Everyone (SAFE) (if there is baseline info) </label>
                                                            <ul class="custom-control-group g-3 align-center">
                                                                <li><input type="text" class="form-control " id="q22_lv" name="q22_lv" value='<?if(strlen($q22_lv)!=0) echo $q22_lv; else echo $rsmember['q2_2a'];?>' placeholder="Achievement" onblur="q2(form1.q22_lv,form1.q22_uv,form1.q2_2)"></li>
                                                                <li><input type="text" class="form-control " id="q22_uv" name="q22_uv" value='<?if(strlen($q22_uv)!=0) echo $q22_uv; else echo $rsmember['q2_2b'];?>' placeholder="Target" onblur="q2(form1.q22_lv,form1.q22_uv,form1.q2_2)"></li>
                                                                <li><div class="user-avatar bg-gray-400 ml-2 mr-2 sm"><span>OR</span></div></li>
                                                                <li>
                                                                <div class="form-control-wrap">
                                                                <div class="form-icon form-icon-right">%</div>    
                                                                    <input type="text" class="form-control" id="q2_2" name="q2_2" value='<?if(strlen($q2_2)!=0) echo $q2_2; else echo $rsmember['q2_2c'];?>' onblur="q2(form1.q22_lv,form1.q22_uv,form1.q2_2)">
                                                                </div>
                                                            </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">3. Hospital infrastructure grants and sustainability consultations</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">3.1 Number of Infrastructure projects supported.</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px   ">4. Increase the numbers of health workers and train the future health workforce</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12">
                                                        <div class="form-group mb-3">
                                                            <label class="form-label" for="default-03">4.1 Total number of trainees (of all types of training)</label>
                                                            <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-sm-12 ">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">4.2 Number of individuals graduated from the training programs. </label>
                                                            <div class="form-control-wrap">
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=31' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
