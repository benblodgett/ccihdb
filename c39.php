...
{    
    $sqlQuery="SELECT * FROM c39  WHERE sno='$editQuery'";  
...
if($fstat=='Completed'){
    ...
    if ( $errval != true ) {
        $sqlQuery="SELECT * FROM c39 WHERE  rp='$RepPer'";
        //echo $sqlQuery;
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            $sqlQuery1="update c39 set q1_1=" . empty2null($q1_1) . ",q1_2=" . empty2null($q1_2) . ",q2_1=" . empty2null($q2_1) . ", q2_2a=" . empty2null($q22_lv) . ",q2_2b=" . empty2null($q22_uv) . ",q2_2c=" . empty2null($q2_2) . ",mov='$MOV',ra='$RAss',fs='$fstat',uuser='$uname',udt='$datetime' where rp='$RepPer' ";
            ...
            if($result1)
                ...
                $sqlQuery1="Insert into c39(rp,q1_1,q1_2,q2_1,q2_2a,q2_2b,q2_2c,mov, ra, fs, cuser, cdt,uuser,udt ) values ('$RepPer'," . empty2null($q1_1) . "," . empty2null($q1_2) . "," . empty2null($q2_1) . "," . empty2null($q22_lv) . "," . empty2null($q22_uv) . "," . empty2null($q2_2) . ",'$MOV','$RAss','$fstat','$uname','$datetime','$uname','$datetime') ";
                $result1=mysqli_query($CCIHCon,$sqlQuery1)or die(mysqli_error($CCIHCon));//die("Unable connect to the table");
                sendMail($fstat,$RepPer,$CCIHCon);
                if($result1)
...
{    
    if($val=='Completed'){
        $sqlQuery="SELECT * FROM c39 WHERE  rp='$rp'";
        $result=mysqli_query($CCIHCon,$sqlQuery)or die(mysqli_error($CCIHCon));
        if( mysqli_num_rows($result) > 0){
            ...
            $html .='
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b>  1. Call for Compassion commits to achieving health for all through an ongoing health sponsorship program, launched in January 2022. This involves selected individuals in the community who are receiving a monthly income (financially able) sponsoring the health needs of individuals (often based in rural regions) who lack the financial means to afford quality healthcare. Typically, each sponsor will sponsor one or two vulnerable people. CFC will also be working towards encouraging local churches to provide sustainable financial support to improve access to health amongst vulnerable populations</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >1.1 Number of patients achieving cost savings goals</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q1_1'].'</b></td>
                </tr>
                <tr >
                <td width="80%" >1.2 Number of patient population covered by health insurance (sponsorship program)</td>
                ...
                <table cellpadding="4">
                <tr>
                <td colspan="2" ><b> 2. Periodic training will be provided to the CFC health staff and health staff of health facilities run by local churches, especially for vulnerable people in their communities. This program was launched in October 2015 and is ongoing, and will focus on provision of quality health care, including NCDs, pandemic preparedness, malaria, and care for elderly populations. CFC will be using external training resources sourced from members of the Micah Global Network</b></td>
                </tr>
                <tr class="border_bottom">
                <td width="80%" >2.1 Number of health staff trained .</td>
                <td width="20%" style="text-align:center;"><b>'.$valu1['q2_1'].'</b></td>
                </tr> 
                <tr class="border_bottom">
                <td colspan="2">2.2 Percentage of staff receiving training in key skill areas and having up-to-date skills <br/>&nbsp;&nbsp;&nbsp;    Achievement: <b>'.$valu1['q2_2a'].'</b>&nbsp;&nbsp;&nbsp;   Target: <b>'.$valu1['q2_2b'].'</b>&nbsp;&nbsp;&nbsp;   % value: <b>'.$valu1['q2_2c'].'</b></td>
                </tr> 
                </table>
                </td>
                </tr>                
...
$rparray = [];
$rp_array =0;
$rpresult=mysqli_query($CCIHCon,"SELECT rp FROM c39")or die(mysqli_error($CCIHCon));
                                ...
                                <div class="alert alert-bi-file bg-primary text-white mb-0 rounded-0">
                                    <div class="ccih-block-head ccih-block-head-lg ">
                                        <div class="ccih-block-head-content">
                                            <h4 class="ccih-block-title fw-normal"><em class="icon ni ni-blank"></em> Appel à la Compassion - Quantitative</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-preview rounded-0">
                                            ...
                                            <?
                                                ...
                                                <div class="alert alert-light mt-2">
                                                    ...
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">1. Call for Compassion commits to achieving health for all through an ongoing health sponsorship program, launched in January 2022. This involves selected individuals in the community who are receiving a monthly income (financially able) sponsoring the health needs of individuals (often based in rural regions) who lack the financial means to afford quality healthcare. Typically, each sponsor will sponsor one or two vulnerable people. CFC will also be working towards encouraging local churches to provide sustainable financial support to improve access to health amongst vulnerable populations</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.1 Number of patients achieving cost savings goals</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">1.2 Number of patient population covered by health insurance (sponsorship program)</label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="alert alert-light mt-2">
                                                    <div class="col-md-12 mt-4 ">
                                                        <span class="preview-title-sm fw-bold text-danger fs-15px  ">2. Periodic training will be provided to the CFC health staff and health staff of health facilities run by local churches, especially for vulnerable people in their communities. This program was launched in October 2015 and is ongoing, and will focus on provision of quality health care, including NCDs, pandemic preparedness, malaria, and care for elderly populations. CFC will be using external training resources sourced from members of the Micah Global Network</span>
                                                    </div>
                                                    <hr class="preview-hr mt-0">
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.1 Number of health staff trained </label>
                                                            <div class="form-control-wrap">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label" for="default-03">2.2 Percentage of staff receiving training in key skill areas and having up-to-date skills  </label>
                                            ...
                                            <div class="alert alert-bi-file bg-gray-200  rounded-0">
                                                    ...
                                                    <?if($_COOKIE["previ"]!="SA"){?>   
                                                        ...
                                                        <?}else{?>
                                                            <a href='cselection.php?sel=2&pg=2&cid=39' class="btn btn-lg btn-secondary">Exit form</a>
                                                        <?}?>
                                                    </div>
                                                    </div>
